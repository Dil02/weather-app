...
export default class Temperature extends Component {
    ...
    render() {
        ...
        //Determines the background image to be used based on values passed as props.
        let bgImage;
            ...
            <div class={`${style.containerT} ${bgImage}`}>
                <header class={style.headerT}>
                    <img id={style.returnT}
                        onClick={() => this.props.switchPageTo(this.props.PAGES.HOME)} //Enables returning back to the home screen.
                        src="../../assets/icons/left-arrow-orange.png"></img>
