...
export default class CitySelect extends Component {
    ...
    render() {
		...
		if (this.props.isNightTime) {
            ...
            titleColour = style.nightLabel;
		} else if (this.props.rain) {
			bgImage = style.rainBg;
            titleColour = style.clearLabel;
		} else {
        ...
        return (
            <div className={`${style.container} ${bgImage}`}>
                ...
                <div className={style.title}>
                    ...
                    <label className={`${style.citysearchLabel} ${titleColour}`} for='userInputtedCity'>Enter a city, area, or district:</label>
                </div>
